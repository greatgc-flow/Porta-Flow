...
def action_register(base_dir):
    ...
    launch_script = base_dir / "_sys" / "cli" / "launch.bat" # Note: changing launch.ps1 to launch.bat later
    ...
    for path_base, arg in reg_paths:
        ...
        try:
            ...
            # Using cmd.exe wrapper for launch
    ...
    auto_block = [
        ...
        f"set \"BASE_DIR_PHYS={base_dir}\"",
        f"set \"MENU_REG_KEY={target_key}\"",
